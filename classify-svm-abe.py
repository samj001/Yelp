...
if __name__ == "__main__":
    ...
    three_food = get_X(f_dict, 3, "food", embedding)
    four_food = get_X(f_dict, 4, "food", embedding)
    five_food = get_X(f_dict, 5, "food", embedding)
    ...
    four_service = get_X(s_dict, 4, "service", embedding, t = "BOW")
    five_service = get_X(s_dict, 5, "service", embedding)
